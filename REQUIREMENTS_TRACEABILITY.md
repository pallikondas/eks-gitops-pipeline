...
| 2.7b | External access, routing, failover | `README.md` curl, pod deletion, and ALB validation procedures | Partial | Execute the commands against the live ALB and record DNS, HTTP responses, target health, and pod replacement evidence. |
